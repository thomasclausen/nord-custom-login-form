...
function nord_password_form() {
	...
	$output .= '<p><label for="' . $label . '">' . __( 'Password' ) . ':<br /><input name="post_password" id="' . $label . '" type="password" size="20" /></label><br /><input type="submit" name="Submit" value="' . esc_attr__( 'Submit' ) . '" /></p>' . "\r\n";
	$output .= '</form>' . "\r\n";
